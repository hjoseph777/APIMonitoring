      ...
      {alerts.length === 0 ? (
              ...
              <div className="flex items-center gap-1.5 shrink-0">
                {!alert.read && (
                  <button
                    ...
                    className="p-2 border border-slate-800 hover:bg-slate-800 rounded-lg text-slate-400 hover:text-green-400 transition-all"
                    title="Mark as Read"
                  >
        ...
        <div className="space-y-6">
          {Object.entries(groupedAlerts).map(([endpointName, groupAlerts]) => (
            <div key={endpointName} className="glass-panel p-5 rounded-2xl border border-slate-800 space-y-4">
